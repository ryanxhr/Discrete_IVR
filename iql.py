...
from d3rlpy.algos import IQL, DiscreteCQL, DiscreteSAC, DiscreteIQL
...
def main(args):
    ...
    name = f'IQL_{args.dataset}_{args.ratio}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='seaquest-medium-v0')
