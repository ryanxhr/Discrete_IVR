...
from d3rlpy.algos import IQL, DiscreteCQL, DiscreteSAC, DiscreteIQL, DiscreteSQL
...
def main(args):
    ...
    sql = DiscreteSQL(
        ...
        scaler='pixel',
        expectile=args.alpha,
        use_gpu=args.gpu)

    sql.fit(train_episodes,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='pong-medium-v0')
